<template>
  <div ref="wrapRef" :class="getWrapperClass">
    <div class="flex h-full">
      <div class="hidden lg:block w-[270px] mr-1" v-if="getBindValues.useSearchForm">
        <BasicFormSidebar
          ref="formRef"
          submitOnReset
          v-bind="getFormProps"
      ...
      <Table
        :class="`flex-1 w-[600px] ${getBindValues.useSearchForm ? 'border-1 border-gray-300' : ''}`"
        ref="tableElRef"
...
<script lang="ts" setup>
  ...
  import { BasicFormSidebar, useForm } from '@/components/Form';
