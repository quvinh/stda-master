  ...
  <div class="flex pt-1 h-full">
    ...
    <div class="flex-1 w-[600px] bg-white flex flex-col h-full">
      <Tabs type="card" v-model:active-key="tabKey" @change="handleTabChange">
        ...
        <TabPane tab="Lịch sử nhập/xuất kho TP" key="history">
          <BasicTable @register="registerTable" />
        </TabPane>
        <TabPane tab="Tồn kho thành phẩm" key="inventory">
...
<script setup lang="ts">
  ...
  import { getBasicColumns, getInventoryColumns } from './tableDataFinishedProduct';
