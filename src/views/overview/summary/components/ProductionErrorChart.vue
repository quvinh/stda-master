...
<script lang="ts" setup>
  ...
  watch(
    ...
    () => {
      ...
      setOptions({
        title: {
          text: 'Tỷ lệ thành phần lỗi chất lượng',
          left: 'center',
          textStyle: {
        ...
        series: [
          {
            name: 'Tỷ lệ thành phần lỗi chất lượng',
            type: 'pie',
            radius: '65%',
            center: ['50%', '60%'], // Di chuyển biểu đồ tròn xuống dưới bằng cách tăng giá trị trục Y
            selectedMode: 'single',
            data: [
              { value: 1548, name: 'Lỗi NVL' },
              { value: 735, name: 'Lỗi độ ẩm' },
              { value: 510, name: 'Sai quy cách' },
              { value: 434, name: 'Lỗi bộ nhớ' },
              { value: 335, name: 'Lỗi tái bản' },
              { value: 400, name: 'Lỗi chất lượng' },
            ],
            label: {
              show: true,
              position: 'outside',
