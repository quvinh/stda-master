<template>
  ...
  >
    <div class="flex-1 flex flex-col h-full pt-5">
      <FormItem label="Mã thiết bị" name="equipment_id">
        <Input v-model:value="formData.equipment_id" placeholder="Vui lòng nhập" allowClear />
      </FormItem>

      <FormItem label="Tên thông số" name="equipment_parameter_id">
        <Input
