<template>
  ...
  >
    <div class="flex-1 flex flex-col h-full pt-5">
      <FormItem label="Tên tài khoản" name="name">
        <Input v-model:value="formData.name" placeholder="Vui lòng nhập" allowClear />
      </FormItem>

      <FormItem label="Tên đăng nhập" name="username">
        <Input v-model:value="formData.username" placeholder="Vui lòng nhập" allowClear />
      </FormItem>

      <FormItem label="Email" name="email">
        <Input v-model:value="formData.email" placeholder="Vui lòng nhập" allowClear />
      </FormItem>
