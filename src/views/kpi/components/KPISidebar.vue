  ...
  >
    <div class="flex-1 flex flex-col h-[calc(100%-60px)]">
      ...
      <div class="flex-1 flex flex-col overflow-y-auto section-search-input pr-1">
        ...
        <FormItem label="Mã đơn hàng" name="order_id">
          <Input placeholder="Vui lòng nhập" v-model:value="formData.order_id" />
        </FormItem>

        <FormItem label="Mã khách hàng" name="customer_id">
          <Input placeholder="Vui lòng nhập" v-model:value="formData.customer_id" />
        </FormItem>
