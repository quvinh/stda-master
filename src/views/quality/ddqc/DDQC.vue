<template>
  <div class="flex flex-col h-full">
    <Card
      ...
      size="small"
      title="Danh sách lịch sử chạy thử"
    >
      <template #extra>
...
<script setup lang="ts">
  import { message, Button, Card } from 'ant-design-vue';
  ...
  async function fetchData(param: any = {}, isExport: boolean = false) {
    loading.value = true;
    try {
      const res = await axiosInstance.get(`v1/qc/ui/fai-histories`, {
        params: param,
        responseType: 'json',
      });
